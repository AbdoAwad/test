    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-8">
            <div class="card" style="box-shadow: 0 3px 3px 0 rgba(0,0,0,0.14), 0 1px 7px 0 rgba(0,0,0,0.12), 0 3px 1px -1px rgba(0,0,0,0.2);">
                ...
                <div class="card-body">
                    <form id="form" method="POST" action="{{route('staff.update', $staff->id)}}"  enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <input value="{{$staff->name}}" name="name" autocomplete="off" required type="text" class="form-control circle" >
                                </div>
                                <div class="form-group ">
                                    <label class="form-label">Email</label>
                                    <input value="{{$staff->email}}" name="email" autocomplete="off" required type="email" class="form-control circle" >
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="password" value="{{$staff->password}}" autocomplete="off" required type="password" class="form-control circle" >
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mt-2 mb-3" >
                                    ...
                                    <input data-default-file="{{url($staff->image)}}" value="{{url($staff->image)}}"  type="file" id="image" name="image" class="dropify">
                                </div>
                            </div>
